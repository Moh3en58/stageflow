<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800">
            {{ ucfirst($evaluationType) }} Evaluation
        </h2>
    </x-slot>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 border-b pb-6">
                        <h1 class="text-2xl font-bold text-gray-900">
                            {{ ucfirst($evaluationType) }}
                            {{ $user->role === 'student' ? 'Self-Evaluation' : 'Mentor Evaluation' }}
                        </h1>

                        <p class="mt-2 text-sm text-gray-600">
                            Score every active competency from 1 to 5.
                        </p>
                    </div>
                    ...
                    >
                            ...
                            <div class="rounded-lg border border-gray-200 p-5">
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        >{{ old("scores.{$competency->id}.comment") }}</textarea>
                        ...
                        @empty
                            <div class="rounded-md border border-yellow-300 bg-yellow-50 p-5 text-yellow-800">
                                No active competencies are available. Add or activate competencies before submitting an evaluation.
                            </div>
                        @endforelse
                        ...
                        <div class="flex items-center justify-between border-t pt-6">
                            ...
                            <button
                                ...
                                class="rounded-md bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                Submit Evaluation
                            </button>
                        </div>
